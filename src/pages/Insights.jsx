        ...
        <section className="bg-white px-5 sm:px-8 py-20">
          <div className="max-w-[1080px] mx-auto">
            <div className="grid border-l border-t border-[#DCE3EC] md:grid-cols-2">
              <Link to="/insights/thought-leadership" className="group border-r border-b border-gold/45 bg-mist p-7 sm:p-9 min-h-[280px] flex flex-col hover:bg-white transition-colors">
                <span className="font-mono text-[11px] text-gold mb-8">01</span>
                <h2 className="font-display text-[27px] font-medium text-navy mb-3">Thought Leadership</h2>
                <p className="text-[15px] text-slate leading-[1.75] mb-8 flex-1">Perspectives on verification, governance, institutional trust, and the evolution of private capital markets.</p>
                <span className="text-sm font-semibold text-navy">Read the articles <span aria-hidden="true" className="inline-block transition-transform group-hover:translate-x-1">→</span></span>
              </Link>
              {SECTIONS.map((item) => (
