      ...
      <main>
        <section className="bg-navy px-8 pt-20 pb-16 text-center">
          <div className="max-w-[760px] mx-auto">
            ...
            <h1 className="font-display text-[clamp(32px,4.5vw,50px)] font-medium leading-[1.15] text-white mb-6">Built around a clear institutional responsibility.</h1>
        ...
        <section className="bg-mist px-8 py-16 border-t border-[#E2E8F0]">
          <div className="max-w-[780px] mx-auto text-center">
            <img src={coreIdentityIcon} alt="CoreIdentity" className="h-10 w-auto mx-auto mb-5" />
            <h2 className="font-display text-2xl font-medium text-navy mb-4">Governed by CoreIdentity Technologies.</h2>
            <p className="text-[15px] text-slate leading-[1.75] mx-auto">CoreG is governed by Trust Infrastructure and Autonomous Execution Governance provided by CoreIdentity Technologies. CoreG remains the intermediary; CoreIdentity Technologies owns and operates the governance infrastructure beneath it.</p>
          </div>
        </section>
      </main>
      <PageFooter />
