      ...
      <main>
        <section className="bg-navy px-5 sm:px-8 pt-20 pb-16 text-center">
          <div className="max-w-[820px] mx-auto">
            ...
            <h1 className="font-display text-[clamp(36px,6vw,62px)] font-medium leading-[1.08] text-white mb-6">Discuss future access to CoreG.</h1>
        ...
        <section className="request-access-page">
          <div className="request-access-shell">
            <div className="request-access-copy">
              ...
              <p>Public onboarding is currently unavailable. This form opens your email application with a preliminary inquiry; it does not create an account or submit information to a CoreG website database. You must send the email yourself.</p>
              <div className="request-access-notice">Do not include passports, bank records, proof of funds, private keys or sensitive transaction documents. An inquiry creates no obligation to fund, purchase, monetize, trade or accept an asset. Any future engagement remains subject to independent verification, compliance review, due diligence, counterparty acceptance and applicable law.</div>
            </div>
